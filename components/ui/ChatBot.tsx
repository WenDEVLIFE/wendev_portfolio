    ...
    return (
        <>
                        ...
                        <div className="p-5 pt-3 border-t border-white/10 shrink-0">
                            ...
                            >
                                ...
                                <input
                                    ...
                                    className="flex-1 bg-black/40 border border-white/10 rounded-xl px-4 py-2.5 text-sm text-white placeholder:text-neutral-700 focus:outline-none focus:border-white/30 transition-colors min-w-0"
                                />
                                <button
                                    type="submit"
            ...
            <motion.button
                ...
                className="fixed bottom-6 right-6 z-[90] bg-white text-black p-4 rounded-full shadow-2xl flex items-center justify-center relative group"
            >
